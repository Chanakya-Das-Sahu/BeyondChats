...
const handleRefine = async (article) => {
  ...
  try {
    ...
    setSelectedArticle({
      ...
      content: refinedData.updatedContent,
            ...
            <div className="p-8 md:p-12">
              {!selectedArticle ? (
                ...
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                  <h1 className="text-4xl font-extrabold text-slate-900 mb-8 leading-tight">{selectedArticle.updatedTitle}</h1>
                  
                  {/* IMPORTANT: This renders the HTML generated by Gemini */}
                  <div 
                    className="prose prose-slate prose-lg max-w-none text-slate-700"
                    dangerouslySetInnerHTML={{ __html: selectedArticle.updatedContent }} 
                  />
